			...
			<div class="container">
				<div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
					<form id="market_reg">
						...
						<h3>행사등록</h3>
						<h6 style="text-align: left; margin-bottom: -1px">행사</h6>
						<input type="text" class="form-control input-lg" placeholder="User Name" />
						<h6 style="text-align: left; margin-bottom: -1px">행사한줄설명</h6>
						<input type="text" class="form-control input-lg" placeholder="User Name" />
						...
						<button type="submit" class="btn btn-primary">등록신청</button>
					</form>
				</div>
			</div>
		</section>
