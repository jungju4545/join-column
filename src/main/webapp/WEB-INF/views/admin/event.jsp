...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <h1 style="margin-top:-80px;margin-left: 15px;">행사 관리</h1><br/><hr/>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <a href="/event/reg" target="_blank">
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i>행사</button>
                                    </div>
                                    </a>
                                </div>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                	<button onclick="alert('마켓상세보기로이동합시다.거기서수정')" style="color:blue;">플리마켓 다모여</button></td>
                                                <td>
                                                    <span class="block-email">경상도</span>
                                                </td>
                                                <td>2018-09-27 ~ 2018-09-27</td>
